...
void testInputNodes(const char* file)
{
	...
	assert(defaultNav.getNode(0)->allDirections[0] == 1);
	assert(defaultNav.getNode(0)->allDirections[1] == 3);
	...
	assert(defaultNav.getNode(1)->allDirections[0] == 2);
	assert(defaultNav.getNode(1)->allDirections[1] == 3);
	...
	assert(defaultNav.getNode(2)->allDirections[0] == 4);
	assert(defaultNav.getNode(2)->allDirections[1] == 2);
	assert(defaultNav.getNode(2)->allDirections[2] == 3);
	...
	assert(defaultNav.getNode(3)->allDirections[0] == 4);
	assert(defaultNav.getNode(3)->allDirections[1] == 1);
	assert(defaultNav.getNode(3)->allDirections[2] == 3);
	...
	assert(defaultNav.getNode(4)->allDirections[0] == 4);
	assert(defaultNav.getNode(4)->allDirections[1] == 4);
}
