...
struct Sensor
{
  enum LocalSensor : int {
    ALL = 0,
    ENVIRONMENT = 1,  //cliff, bumper, dirt detectors, motor over-currents.
    PHYSICAL = 2,     //distance, angle, buttons, remote control commands
    SYSTEM = 3,       //voltage, current, battery charge, battery temperature)
  };
};
